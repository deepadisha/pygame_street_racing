...
pygame.display.set_caption('ABD')
...
carimg7 = pygame.image.load('8.png').convert_alpha()
...
def crashed():
   ...
   TextSurf, TextRect = text_objects("YOU LOST THE GAME", largeText)
   ...
   while True:
        ...
        button("RETRY",350,450,100,50,green,bright_green,gameloop)
...
def game_intro():
    ...
    while intro:
        ...
        gameD.fill(blue)
        largeText = pygame.font.SysFont("comicsansms",115)
        TextSurf, TextRect = text_objects("STREET RACING ", largeText)
        TextRect.center = ((display_w/2),(display_h/2))
        gameD.blit(TextSurf, TextRect)

        button("START",350,450,100,50,green,bright_green,gameloop)
        button("Quit",900,450,100,50,red,bright_red,quitgame)
